        ...
        <div className="relative bg-white/80 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
          <div className="px-6 py-8 opacity-0 animate-fade-in">
            ...
            <p className="text-center text-gray-600 mb-8 animate-slide-up delay-100">
              Sign in to your kiruiz account
            </p>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="transform transition-all duration-300 hover:translate-x-1">
                ...
                <div className="relative group">
                  ...
                  <input id="password" name="password" type={showPassword ? 'text' : 'password'} required className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 hover:border-purple-300" placeholder="••••••••" />
